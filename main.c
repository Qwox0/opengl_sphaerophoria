...
static const char *vertex_shader_text =
    ...
    "layout(location = 0) uniform mat2 rot = mat2(vec2(1, 0), vec2(0, 1));\n"
    "out vec3 color;\n"
    "void main()\n"
    "{\n"
...
int main(void) {
    ...
    GLFWwindow *window =
        glfwCreateWindow(500, 500, "OpenGL Triangle", NULL, NULL);
    if (!window) {
        glfwTerminate();
        exit(EXIT_FAILURE);
    }
    ...
    */
    const GLint vpos_location = 1;
    const GLint vcol_location = 0;
